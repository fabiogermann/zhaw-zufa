...
\hline 
\hline 
\includegraphics[width=5cm]{Funktionen/Injection\lyxdot svg} & \includegraphics[width=5cm]{Funktionen/Surjection\lyxdot svg} & \includegraphics[width=5cm]{Funktionen/Bijection\lyxdot svg}\tabularnewline
\hline 
\end{tabular}
\end{verse}
